    ...
    >
      <div className="container mx-auto flex h-[68px] max-w-[1240px] items-center justify-between px-8">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-[18px] font-bold tracking-[-0.02em] text-[var(--text)]">Eventara</span>
        </div>

        {/* Nav Links */}
        <div className="flex items-center gap-1.5">
          <a href="#events" className="rounded-[10px] px-3.5 py-2 text-[14.5px] text-[var(--text)] transition-colors duration-150 hover:text-[var(--text)]">
            Events
          </a>
          <a href="#about" className="rounded-[10px] px-3.5 py-2 text-[14.5px] text-[var(--text-dim)] transition-colors duration-150 hover:text-[var(--text)]">
            About
          </a>
          <a
            href="#community"
