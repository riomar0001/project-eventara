        ...
        <div className="grid grid-cols-[1fr_auto_auto_auto] items-stretch gap-3">
          ...
          <div className="relative">
            <Icon
              name="search"
              size={16}
              className="absolute left-[18px] top-1/2 -translate-y-1/2 text-[var(--text-mute)]"
            />
            <input
              type="text"
          ...
          <div className="relative">
            ...
            {capacityOpen && (
              <div className="absolute right-0 top-[calc(100%_+_8px)] z-50 min-w-[220px] overflow-hidden rounded-[12px] border border-[var(--line)] bg-[var(--surface)] p-[6px] shadow-[0_20px_60px_-20px_oklch(0_0_0_/_0.5)]">
