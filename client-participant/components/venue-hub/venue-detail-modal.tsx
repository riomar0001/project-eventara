...
export function VenueDetailModal({
  ...
  return (
    <ModalBackdrop isOpen={isOpen} onClose={onClose}>
      <div className="w-full max-w-2xl overflow-hidden rounded-3xl border border-[var(--line)] bg-[var(--surface)] shadow-2xl shadow-[oklch(0_0_0_/_0.3)]">
        {/* Visual Header */}
        ...
        {/* Footer */}
        <div className="border-t border-[var(--line-soft)] px-8 py-4">
          <button
            onClick={onClose}
            className="w-full rounded-full border border-[var(--line)] bg-transparent px-4 py-2.5 font-semibold text-[var(--text-dim)] transition-all hover:bg-[oklch(1_0_0_/_0.04)] hover:text-[var(--text)]"
          >
            Close
          </button>
        </div>
