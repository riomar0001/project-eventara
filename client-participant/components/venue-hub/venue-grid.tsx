...
export function VenueGrid({ venues, onViewDetail, onEditVenue, onShareVenue, onReportVenue, onAddVenue, currentPage = 1 }: VenueGridProps) {
  if (venues.length === 0) {
    return (
      <div className="py-16 text-center">
        <div className="mb-4 text-6xl">🏢</div>
        <h4 className="text-text m-0 mb-2 text-xl font-semibold">No venues found</h4>
        <p className="text-text-dim text-base">Try adjusting your filters or search terms</p>
      </div>
    );
  }
