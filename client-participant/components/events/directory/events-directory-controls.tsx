  ...
  return (
    <>
      ...
      <div className="events-dir-search-row mt-2 grid items-center gap-[14px]" style={{ gridTemplateColumns: '1fr auto' }}>
        ...
        >
          <span className="absolute top-1/2 left-[18px] -translate-y-1/2" style={{ color: 'var(--text-mute)' }}>
            <Icon name="search" size={18} />
          </span>
          <input
            className="w-full border-none bg-transparent py-[18px] pr-[18px] pl-[52px] text-[15.5px] tracking-[-0.01em] outline-none"
          ...
          />
          <span
            className="absolute top-1/2 right-[14px] -translate-y-1/2 rounded-[6px] border px-2 py-1 font-mono text-[10.5px]"
            style={{
              background: 'var(--bg)',
              borderColor: 'var(--line-soft)',
              color: 'var(--text-mute)'
        ...
        <div className="relative" ref={sortRef}>
          ...
          >
            <span className="font-mono text-[10.5px] tracking-[0.14em] uppercase" style={{ color: 'var(--text-mute)' }}>
              Sort
            </span>
      ...
      <div className="mt-[22px] flex flex-wrap items-center gap-[10px]">
        {categories.map((c) => (
          ...
          >
            ...
            <span
              ...
              style={{
                background: cat === c.key ? 'oklch(0 0 0 / 0.15)' : 'oklch(1 0 0 / 0.06)',
        ...
        <div className="mx-1 h-6 w-px" style={{ background: 'var(--line-soft)' }} />
