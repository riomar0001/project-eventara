  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Date badge */}
        <div
          className="absolute top-[14px] left-[14px] z-[2] min-w-[54px] rounded-[10px] border px-[10px] py-2 text-center"
          style={{
        ...
        {ev.status === 'closing' && (
          <div
            className="absolute top-[14px] right-[14px] z-[2] inline-flex items-center gap-[6px] rounded-full px-[9px] py-[5px] font-mono text-[10px] tracking-[0.14em] uppercase"
            style={{
        ...
        {/* Label */}
        <div className="absolute bottom-3 left-[14px] font-mono text-[9.5px] tracking-[0.14em] uppercase" style={{ color: 'oklch(1 0 0 / 0.3)' }}>
          [ event cover · 16:9 ]
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col gap-[10px] px-5 pt-5 pb-[22px]">
        <h3 className="m-0 text-[18px] leading-[1.28] font-semibold tracking-[-0.02em]" style={{ color: 'var(--text)' }}>
          {ev.title}
        </h3>
        ...
        <div className="mt-auto flex flex-col items-stretch gap-[10px]">
          <div className="flex items-center gap-[10px]">
            <div className="h-[3px] flex-1 overflow-hidden rounded-[2px]" style={{ background: 'oklch(1 0 0 / 0.05)' }}>
              <div
            ...
            <span className="font-mono text-[10.5px]" style={{ color: isLow ? 'var(--amber)' : 'var(--text-mute)' }}>
              {isFull ? (
