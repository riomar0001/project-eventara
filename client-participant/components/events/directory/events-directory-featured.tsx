...
export function EventsDirectoryFeatured({
  featured,
  onOpen,
}: EventsDirectoryFeaturedProps) {
  return (
    <div
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 85% 20%, oklch(0.82 0.17 75 / 0.18), transparent 45%)",
        }}
      />
      ...
      <div className="relative flex flex-col gap-[14px] px-[44px] py-10">
        ...
        <h2
          className="my-1 max-w-[18ch] text-balance font-semibold leading-[1.08] tracking-[-0.03em]"
          style={{
        ...
        <p
          className="m-0 max-w-[48ch] text-[14.5px] leading-[1.55]"
        ...
        {/* Meta */}
        <div
          className="mt-2 grid grid-cols-3 gap-5 border-y py-[18px]"
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(105deg, transparent 0 24px, oklch(1 0 0 / 0.028) 24px 26px)",
          }}
        />
        {/* Orbs */}
        <div
          className="absolute left-[20%] top-[30%] h-[220px] w-[220px] rounded-full opacity-30 blur-[34px]"
          style={{ background: "var(--lime)" }}
        />
        <div
          className="absolute bottom-[18%] right-[12%] h-[180px] w-[180px] rounded-full opacity-45 blur-[30px]"
          style={{ background: "var(--amber)" }}
        />
        {/* Year */}
        <div
          className="absolute right-10 top-8 font-bold leading-[0.8] tracking-[-0.05em]"
          style={{
        ...
        {/* Label */}
        <div
          className="absolute bottom-4 left-5 font-mono text-[10px] uppercase tracking-[0.16em]"
