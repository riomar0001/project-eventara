    ...
    <section className="relative pt-10" style={{ padding: '10px 0 120px' }}>
      <div className="container mx-auto max-w-[1240px] px-8">
        <div
          ...
          style={{
            background: 'linear-gradient(180deg, oklch(0.985 0.004 150), oklch(0.95 0.008 150))'
          }}
        >
          {/* Border gradient */}
          <div
            ...
            style={{
              padding: '1.5px',
              background: 'linear-gradient(135deg, var(--lime) 0%, transparent 40%, transparent 60%, var(--amber) 100%)',
