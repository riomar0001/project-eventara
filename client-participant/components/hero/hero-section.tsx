      ...
      <div className="container relative z-10 mx-auto max-w-[1240px] px-8">
        ...
        >
          ...
          <span
            ...
            style={{
              background:
                "linear-gradient(100deg, var(--lime) 20%, oklch(0.95 0.2 140) 70%)",
        ...
        >
          Your centralized hub to discover, join, and engage with the premier
          Web3 and DeFi events in the region — built by participants, for
          participants.
        </p>

        {/* CTA Buttons */}
        <div className="flex flex-wrap justify-center gap-3.5">
          <button className="btn btn-primary px-6 py-3.5 text-base text-white">
            Explore Events →
          </button>
          <button className="btn btn-amber-outline px-6 py-3.5 text-base">
            Join the Community
          </button>
        </div>
