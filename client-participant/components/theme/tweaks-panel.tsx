    ...
    <div className="fixed bottom-8 right-8 z-50">
      ...
      {isOpen && (
        <div className="absolute bottom-16 right-0 w-56 space-y-4 rounded-2xl border border-[var(--line-soft)] bg-[var(--surface)] p-4 shadow-lg">
              ...
              <button
                ...
                className={cn(
                  ...
                  currentTheme === index
                    ...
                    : "border border-[var(--line-soft)] text-[var(--text)] hover:border-[var(--lime)]"
                )}
              >
                {preset.name}
              </button>
          ...
          <div className="border-t border-[var(--line-soft)] pt-3 text-xs text-[var(--text-mute)]">
            Click to change theme colors. Refresh to reset.
          </div>
        </div>
      )}
    </div>
