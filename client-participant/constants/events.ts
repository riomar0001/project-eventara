...
export const MOCK_EVENTS: Event[] = [
  {
    ...
    category: "workshop",
    description:
      "Learn the basics of decentralized finance and how to get started with smart contracts.",
  },
  {
    id: "evt-002",
    ...
    category: "conference",
    description:
      "Expert discussion on securing wallets, smart contracts, and protecting your digital assets.",
  },
  {
    id: "evt-003",
    ...
    category: "meetup",
    description:
      "Casual gathering for community members to connect, share ideas, and build relationships.",
  },
  {
    id: "evt-004",
    ...
    category: "workshop",
    description:
      "Hands-on bootcamp for developers learning Solidity and blockchain programming.",
  },
  {
    id: "evt-005",
    ...
    category: "conference",
    description:
      "Industry experts share proven trading strategies and market insights.",
  },
  {
    id: "evt-006",
    ...
    category: "meetup",
    description:
      "Explore the intersection of art and blockchain with local digital artists and creators.",
  },
]
...
export const LIVE_EVENT: LiveEvent = {
  ...
  endTime: "3:00 PM",
  description:
    "Join Alex for a deep dive into modern DApp development patterns and production-ready strategies.",
}
