  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-5 py-12">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Suspense fallback={<div className="h-80 rounded-3xl border border-border bg-card" />}>
          <VerifyOtpForm />
        </Suspense>
        <div className="mt-5 text-center">
          <Link href="/login" className="text-[13px] text-muted-foreground transition-colors hover:underline">← Back to sign in</Link>
        </div>
      </div>
    </main>
  );
