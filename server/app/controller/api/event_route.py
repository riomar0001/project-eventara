...
Exposes endpoints for creating events, updating event metadata, and updating
individual event sessions.  Authentication is required; no RBAC feature gate
is applied so any verified user may create or update their own events.

Error mapping summary:
  - 400  date or business-rule constraint violated
...
from app.controller.dependencies.use_cases_depends import get_event_use_case
