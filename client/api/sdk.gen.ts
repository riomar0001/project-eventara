...
import type {
  ...
  ChangePasswordUserChangePasswordPostData,
  ChangePasswordUserChangePasswordPostErrors,
  ChangePasswordUserChangePasswordPostResponses,
  CreateGrantsUserGrantsPostData,
  CreateGrantsUserGrantsPostErrors,
  CreateGrantsUserGrantsPostResponses,
  CreateVenueVenuesPostData,
  CreateVenueVenuesPostErrors,
  CreateVenueVenuesPostResponses,
  DeleteDeadJobQueuesDlqJobIdDeleteData,
  DeleteDeadJobQueuesDlqJobIdDeleteErrors,
  DeleteDeadJobQueuesDlqJobIdDeleteResponses,
  DeleteVenueVenuesVenueIdDeleteData,
  DeleteVenueVenuesVenueIdDeleteErrors,
  DeleteVenueVenuesVenueIdDeleteResponses,
  ...
  GetUserVenuesVenuesCreatorCreatorIdGetData,
  GetUserVenuesVenuesCreatorCreatorIdGetErrors,
  GetUserVenuesVenuesCreatorCreatorIdGetResponses,
  GetVenueVenuesVenueIdGetData,
  GetVenueVenuesVenueIdGetErrors,
  GetVenueVenuesVenueIdGetResponses,
  ...
  ResendVerificationAuthResendVerificationPostData,
  ResendVerificationAuthResendVerificationPostErrors,
  ResendVerificationAuthResendVerificationPostResponses,
  ResetPasswordAuthResetPasswordTokenPostData,
  ResetPasswordAuthResetPasswordTokenPostErrors,
  ResetPasswordAuthResetPasswordTokenPostResponses,
  ...
  UpdateAssignmentUserRolesAssignmentIdPatchResponses,
  UpdateVenueVenuesVenueIdPatchData,
  UpdateVenueVenuesVenueIdPatchErrors,
  UpdateVenueVenuesVenueIdPatchResponses,
...
import {
  ...
  zChangePasswordUserChangePasswordPostBody,
  zChangePasswordUserChangePasswordPostResponse,
  zCreateGrantsUserGrantsPostBody,
  zCreateGrantsUserGrantsPostResponse,
  zCreateVenueVenuesPostBody,
  zCreateVenueVenuesPostResponse,
  zDeleteDeadJobQueuesDlqJobIdDeletePath,
  zDeleteDeadJobQueuesDlqJobIdDeleteResponse,
  zDeleteVenueVenuesVenueIdDeletePath,
  zDeleteVenueVenuesVenueIdDeleteResponse,
  zForgotPasswordAuthForgotPasswordPostBody,
  zForgotPasswordAuthForgotPasswordPostResponse,
  ...
  zGetUserVenuesVenuesCreatorCreatorIdGetPath,
  zGetUserVenuesVenuesCreatorCreatorIdGetResponse,
  zGetVenueVenuesVenueIdGetPath,
  zGetVenueVenuesVenueIdGetResponse,
  ...
  zResendVerificationAuthResendVerificationPostResponse,
  zResetPasswordAuthResetPasswordTokenPostBody,
  zResetPasswordAuthResetPasswordTokenPostPath,
  zResetPasswordAuthResetPasswordTokenPostResponse,
  ...
  zUpdateVenueVenuesVenueIdPatchBody,
  zUpdateVenueVenuesVenueIdPatchPath,
  zUpdateVenueVenuesVenueIdPatchResponse,
...
export class Authentication {
   ...
   * Re-dispatch the email verification link for an unverified account. The response is always 200 OK regardless of whether the address is registered, the account is inactive, or the email is already verified — this prevents user enumeration. Each call issues a fresh signed token; previously sent links remain valid until they expire, but the verification endpoint's conditional UPDATE ensures only the first successful confirmation is ever applied.
   */
  public static resendVerificationAuthResendVerificationPost<ThrowOnError extends boolean = false>(
    options: Options<ResendVerificationAuthResendVerificationPostData, ThrowOnError>
  ) {
  ...
  public static loginVerifyAuthLoginVerifyGet<ThrowOnError extends boolean = false>(options: Options<LoginVerifyAuthLoginVerifyGetData, ThrowOnError>) {
    return (options.client ?? client).post<LoginVerifyAuthLoginVerifyGetResponses, LoginVerifyAuthLoginVerifyGetErrors, ThrowOnError>({
      requestValidator: async (data) =>
        await z
          .object({
   ...
   * Send a password reset link to the given email address. The response is always 200 OK regardless of whether the address is registered — this prevents user enumeration attacks. If the account is eligible (active, email verified), a signed single-use reset token is stored in Redis and emailed as a link. Any previously pending reset token for the same account is atomically overwritten, so only the most recently requested link is valid. The link expires in 1 hour and can only be used once.
   */
  public static forgotPasswordAuthForgotPasswordPost<ThrowOnError extends boolean = false>(
   ...
   * Consume a single-use password reset token and replace the account password. The token is taken from the URL path and validated in two stages: the JWT signature and expiry are verified first, then the token's SHA-256 hash is atomically retrieved and deleted from Redis (``GETDEL``), making replay attacks impossible. If two requests arrive simultaneously with the same token only one will succeed; the second receives 400 with the same opaque error as an invalid token to avoid leaking whether the token was consumed by a concurrent request. On success the new password is persisted and the reset timestamp is updated.
   */
  public static resetPasswordAuthResetPasswordTokenPost<ThrowOnError extends boolean = false>(
    options: Options<ResetPasswordAuthResetPasswordTokenPostData, ThrowOnError>
  ) {
    return (options.client ?? client).post<ResetPasswordAuthResetPasswordTokenPostResponses, ResetPasswordAuthResetPasswordTokenPostErrors, ThrowOnError>({
      requestValidator: async (data) =>
        await z
...
export class User {
   ...
   * Replace the authenticated user's current password with a new one. The caller must supply their existing password for verification before any change is applied. The new password must be at least 8 characters and must differ from the current password. On success, all active refresh tokens for the account are immediately revoked — every other session is invalidated as a security measure, requiring re-authentication. The current session's access token remains valid until its natural expiry, but its refresh token is also revoked so it cannot be silently rotated.
   */
  public static changePasswordUserChangePasswordPost<ThrowOnError extends boolean = false>(
    options: Options<ChangePasswordUserChangePasswordPostData, ThrowOnError>
  ) {
    return (options.client ?? client).post<ChangePasswordUserChangePasswordPostResponses, ChangePasswordUserChangePasswordPostErrors, ThrowOnError>({
      requestValidator: async (data) =>
        await z
...
export class Venues {
   ...
   */
  public static getUserVenuesVenuesCreatorCreatorIdGet<ThrowOnError extends boolean = false>(
    options: Options<GetUserVenuesVenuesCreatorCreatorIdGetData, ThrowOnError>
  ) {
