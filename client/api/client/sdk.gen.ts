 ...
 */
export const revokeAssignmentUserRolesAssignmentIdDelete = <ThrowOnError extends boolean = false>(options: Options<RevokeAssignmentUserRolesAssignmentIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<RevokeAssignmentUserRolesAssignmentIdDeleteResponses, RevokeAssignmentUserRolesAssignmentIdDeleteErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const revokeGrantUserGrantsGrantIdDelete = <ThrowOnError extends boolean = false>(options: Options<RevokeGrantUserGrantsGrantIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<RevokeGrantUserGrantsGrantIdDeleteResponses, RevokeGrantUserGrantsGrantIdDeleteErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
