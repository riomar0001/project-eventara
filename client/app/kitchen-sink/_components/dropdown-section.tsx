    ...
    <Section title="Dropdown Menu">
      <Card>
        <CardContent className="flex flex-wrap gap-4 pt-2">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="gap-1.5">Actions <ChevronDown className="size-3.5" /></Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
          ...
          {/* Checkbox items */}
          <div className="flex flex-col gap-1.5">
            <p className="text-[10px] text-muted-foreground">Checkbox items</p>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="gap-1.5">View options <ChevronDown className="size-3.5" /></Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
                <DropdownMenuLabel>Columns</DropdownMenuLabel>
                <DropdownMenuSeparator />
                <DropdownMenuCheckboxItem checked={checkboxA} onCheckedChange={setCheckboxA}>Show amount</DropdownMenuCheckboxItem>
                <DropdownMenuCheckboxItem checked={checkboxB} onCheckedChange={setCheckboxB}>Show category</DropdownMenuCheckboxItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
          ...
          {/* Radio group */}
          <div className="flex flex-col gap-1.5">
            <p className="text-[10px] text-muted-foreground">Radio group</p>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
          ...
          {/* Sub menu */}
          <div className="flex flex-col gap-1.5">
            <p className="text-[10px] text-muted-foreground">Sub menu</p>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="gap-1.5">More <ChevronDown className="size-3.5" /></Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
                <DropdownMenuItem><Mail className="size-4" /> Email</DropdownMenuItem>
                <DropdownMenuSub>
                  <DropdownMenuSubTrigger><Phone className="size-4" /> Share via</DropdownMenuSubTrigger>
                  <DropdownMenuSubContent>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem><Copy className="size-4" /> Copy link</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
        </CardContent>
