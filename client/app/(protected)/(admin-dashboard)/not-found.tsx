...
export default function NotFound() {
  ...
  return (
    <div className="relative isolate flex min-h-[calc(100svh-3.5rem)] flex-col items-center justify-center overflow-hidden px-6 py-16 text-center">
      ...
      {/* 404 hero numeral */}
      <div aria-label="404" className="relative leading-none select-none">
        {/* Ghost fill layer — very faint primary */}
        <span
          aria-hidden
          className="absolute inset-0 block text-[9rem] leading-none font-black sm:text-[11rem] lg:text-[13rem]"
          style={{
        ...
        {/* Outlined layer */}
        <span
          className="relative block text-[9rem] leading-none font-black sm:text-[11rem] lg:text-[13rem]"
          style={{
      ...
      <div className="mt-4 max-w-[20rem] space-y-2.5">
        <h1 className="text-[1.125rem] leading-snug font-semibold tracking-tight" style={{ color: 'var(--foreground)' }}>
          Page not found
        </h1>
        <p className="text-sm leading-relaxed" style={{ color: 'var(--muted-foreground)' }}>
          This page doesn&apos;t exist or you don&apos;t have permission to view it. If you think this is a mistake, contact your administrator.
        </p>
      </div>
