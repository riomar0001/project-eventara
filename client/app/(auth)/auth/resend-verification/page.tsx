  ...
  if (sent) {
    return (
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-[1.75rem] font-bold tracking-tight text-foreground">Email sent!</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          If <span className="font-medium text-foreground">{sentEmail}</span> has an unverified
          account, a new confirmation link is on its way. Check your spam folder if you don&apos;t see it.
        </p>
